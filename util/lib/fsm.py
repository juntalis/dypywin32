...
class ExceptionFSM(Exception):
	...
	def __init__(self, value, *args, **kwargs):
		super(ExceptionFSM, self).__init__(*args, **kwargs)
		self.value = value
...
class FSM:
	...
	def __init__(self, initial_state, memory = None, results = None):
	...
	def reset(self):
		...
		self.input_symbol = None
		self.index = 0
		self.results = self.initial_results

	def clear_context(self):
		""" Added to allow clearing out the current context of the state machine without
		   changing the index of input stuff. """
		self.initial_index = -1
		self.scope_level = 0
